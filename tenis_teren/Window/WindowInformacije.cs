...
{
    public partial class WindowInformacije : Form
    {
        public WindowInformacije()
        {
            InitializeComponent();
        ...
        private void WindowInformacije_Load(object sender, EventArgs e)
        {
            richTextBox1.Hide();
            button1.Hide();
            ...
            if (WindowPrijava.prijavljen_upravitelj)
            {
                richTextBox1.Show();
                button1.Show();
            }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Uspješno ste spremili nove informacije");
        }
    }
}
